...
import com.escudo7.pedidovenda.model.EnderecoEntrega;
import com.escudo7.pedidovenda.model.FormaPagamento;
import com.escudo7.pedidovenda.model.ItemPedido;
import com.escudo7.pedidovenda.model.Pedido;
import com.escudo7.pedidovenda.model.Produto;
import com.escudo7.pedidovenda.model.StatusPedido;
...
public class TestePedido {
	...
	public static void main(String[] args) {
		...
		enderecoEntrega.setCidade("Fortaleza");
		enderecoEntrega.setUf("CE");
		enderecoEntrega.setCep("3488-123");
		...
		pedido.setObservacao("Aberto das 08 ás 18h");
